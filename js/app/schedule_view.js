...
export const ScheduleView = {
    ...
    async fetchTeamData(teamId) {
        ...
        if (error) {
            console.error("[ScheduleView] Error fetching team data:", error);
            return null;
        }
        return data;
    },
    ...
    async render(containerId, teamId) {
        ...
        const leagueName = teamData?.leagues?.league_name || 'League';
        ...
        try {
            ...
            container.innerHTML = `
                <div class="schedule-view-wrapper" style="padding: 20px; background: #f8f9fa; font-family: 'Inter', sans-serif;">
                    ...
                    <!-- NOWY NAGŁÓWEK - zgodny z roster_view.js -->
                    <div class="schedule-management-header" style="padding: 20px; display: flex; justify-content: space-between; align-items: center;">
                        <div>
                            <h1 style="margin:0; font-weight:900; color:#1a237e; text-transform:uppercase; font-family: 'Inter', sans-serif;">
                                SCHEDULE <span style="color:#e65100">& MATCHES</span>
                            </h1>
                            <p style="margin:0; color:#64748b;">
                                Current squad: <strong style="color:#1a237e">${teamName}</strong> | 
                                League: <strong style="color:#1a237e">${leagueName}</strong>
                            </p>
                        </div>
